...
% Last Modified by GUIDE v2.5 20-Sep-2015 13:07:23
...
function servoslider_Callback(hObject, eventdata, handles)
% hObject    handle to servoslider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
set (handles.servocurrsetpos, 'String', get(handles.servoslider, 'Value'));


% --- Executes during object creation, after setting all properties.
function servoslider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to servoslider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function picturetexttoshow_Callback(hObject, eventdata, handles)
% hObject    handle to picturetexttoshow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of picturetexttoshow as text
%        str2double(get(hObject,'String')) returns contents of picturetexttoshow as a double


% --- Executes during object creation, after setting all properties.
function picturetexttoshow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to picturetexttoshow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in Pictureboxshow.
function Pictureboxshow_Callback(hObject, eventdata, handles)
% hObject    handle to Pictureboxshow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

%To Show Picture in Picture Box
axes (handles.picturebox);
imshow (get(handles.picturetexttoshow,'String'));
